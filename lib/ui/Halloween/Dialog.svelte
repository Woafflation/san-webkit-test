...
<Dialog {...$$props} noTitle bind:closeDialog class="dialog-dZbcwN">
  ...
  {:else if hasDiscount}
    ...
    />
  {:else}
    <FlamePumpkin class="flame-pumpkin-3jsPmZ" />
  {/if}
  <div class="column hv-center txt-center">
    ...
    {#if hasDiscount || code}
      <DiscountCode class="copy-14bbSy" discount={code || 'SANHALLOWEEN2022'} />
      <a
