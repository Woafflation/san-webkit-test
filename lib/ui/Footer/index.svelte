    ...
    <div class="body-2 row top justify c-waterloo">
      ...
      <div class="forms">
        <div class="digest">
          ...
          <DigestForm
            class="mrg-xl mrg--b form-2MyXxC {$IsMobile ? '' : 'body-3'}"
            label="Subscribe"
          />
        </div>
      </div>
...
:global(body:not(.desktop)) :global(.form-2MyXxC) {
  width: auto;
}
...
:global(.phone-xs) :global(.form-2MyXxC),
:global(.phone) :global(.form-2MyXxC) {
  margin-bottom: 40px;
}
