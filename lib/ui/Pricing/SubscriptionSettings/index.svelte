...
<section id="subscription" class="border {className}">
  ...
  <Setting class="subscriptions-thB7O4">
    <UserPlanCard
      {plan}
      {subscription}
      {isEligibleForTrial}
...
:global(.phone) :global(.subscriptions-thB7O4),
:global(.tablet) :global(.subscriptions-thB7O4),
:global(.phone-xs) :global(.subscriptions-thB7O4) {
