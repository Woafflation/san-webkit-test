...
<Tooltip
  ...
  <svelte:fragment slot="trigger">
    <a
      ...
      class:pro={isPro}>
      <Pic class="btn mrg-m mrg--l box-2GMUy" src={currentUser ? currentUser.avatarUrl : ''} />
    </a>
  </svelte:fragment>
...
<style>
  :global(.active-2fbtIP) :global(.box-2GMUy) {
    box-shadow: inset 0px 0px 0px 1px var(--green);
  }

  .pro :global(.box-2GMUy) {
